...
### Description
It takes the csv file input from the user. Futher, generates a new csv file that includes sha256 hash of CHIP-007 NFT compatible JSON. The CHIP-007 NFT compatible JSON file is auto generated by the script, the moment user supplies their desired csv file. 
